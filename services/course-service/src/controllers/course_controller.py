...
def _validate_create_course_payload(payload: Dict[str, Any]) -> Tuple[bool, JSONResponse | None, Tuple[str, str, str, int, List[str]] | None]:
...
def _persist_course(
    ...
    SessionLocal, Course, CourseInfo, UnderstandLevelTag = _lazy_models()
