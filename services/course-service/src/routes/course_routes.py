...
async def list_public_courses(search: Optional[str] = Query(default=None), owner_id: Optional[str] = Query(default=None)):
    return list_public_courses_controller(search, owner_id)
