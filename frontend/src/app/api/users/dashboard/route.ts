/**
 * =============================================================================
 * 📊 PATHLIGHT FRONTEND - USER DASHBOARD API ROUTES
 * =============================================================================
 * Next.js API routes for user dashboard data
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await proxyToUserService('/dashboard', 'GET', headers);
    return handleApiResponse(response);
  } catch (error) {
    console.error('[USER DASHBOARD API] GET error:', error);
