...
const fakeQuizzes = [
	{
		id: 'q1',
		title: 'JavaScript Cơ Bản - Ôn Tập',
		description:
			'Quiz bao phủ biến, kiểu dữ liệu, toán tử, hàm cơ bản và vòng lặp. Lý tưởng để kiểm tra kiến thức sau tuần học đầu tiên.',
		questions: 15,
		attempts: 2,
		bestScore: 80,
		avgScore: 72,
	...
	{
		id: 'q2',
		title: 'CSS Layout Nâng Cao',
		description:
			'Flexbox, Grid, responsive patterns, stacking context và kỹ thuật layout hiện đại.',
		questions: 20,
		attempts: 1,
		bestScore: 60,
		avgScore: 60,
	...
	},
	{
		...
		description:
			'Tập trung vào generics, conditional types, mapped & utility types nhằm củng cố tư duy kiểu.',
		questions: 25,
		attempts: 0,
		bestScore: 0,
		avgScore: 0,
...
// Sort option type
type SortOption = 'latest' | 'progress_desc' | 'title_asc' | 'score_desc';
...
export default function MyQuizzesPage() {
	...
	const filtered = useMemo(() => {
		...
		switch (sort) {
			...
			case 'title_asc':
				...
				break;
			case 'score_desc':
				list = [...list].sort((a, b) => b.bestScore - a.bestScore);
				break;
			default:
				list = [...list].sort(
					(a, b) =>
	...
	return (
		<Layout title="Quiz Của Tôi" user={user}>
					...
					<div className="flex items-center gap-2">
						...
						<div className="relative">
							...
							>
								...
								<option value="score_desc">Điểm cao</option>
					...
					{pageItems.map((quiz) => (
						...
						>
							...
							<div className="flex flex-wrap items-center gap-x-8 gap-y-3 text-sm text-gray-600 mb-4">
								<div>{quiz.questions} Câu hỏi</div>
								<div>Thử: {quiz.attempts}</div>
								<div>
									Điểm cao:{' '}
