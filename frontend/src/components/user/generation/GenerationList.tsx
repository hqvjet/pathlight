  ...
  if (loading) {
    return (
      <Card className="p-12 text-center border-gray-100">
        ...
        <p className="mt-4 text-gray-600 font-medium">Đang tải tiến trình tạo khóa học...</p>
  ...
  if (!items || items.length === 0) {
    return (
      <Card className="p-12 text-center border-dashed border-gray-300">
        ...
        <p className="text-gray-500 mb-4">Bạn chưa tạo khóa học nào hoặc chưa có dữ liệu theo dõi.</p>
