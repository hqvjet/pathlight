      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between mb-2">
          <div className="flex-1">
            <CardTitle className="text-2xl font-bold mb-1 text-gray-900 group-hover:text-orange-600 transition-colors">
              {course.title}
            </CardTitle>
            {course.subtitle && (
          ...
          {hasRecommendationScore && (
            <Badge className="shrink-0 ml-2 border-amber-200 text-amber-700 bg-amber-50">
              ...
              {(course.recommendation_score * 100).toFixed(0)}% phù hợp
            </Badge>
          )}
        </div>
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex-1 min-w-0">
            <CardTitle className="text-xl font-bold text-gray-900 group-hover:text-orange-600 transition-colors leading-tight mb-2 truncate">
              {course.title}
            </CardTitle>
            {course.subtitle && (
